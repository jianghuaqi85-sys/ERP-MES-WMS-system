...
// The ProductionRecordFunc type is an adapter to allow the use of ordinary
// function as ProductionRecord mutator.
type ProductionRecordFunc func(context.Context, *ent.ProductionRecordMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ProductionRecordFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ProductionRecordMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ProductionRecordMutation", m)
}
...
// The StockRecordFunc type is an adapter to allow the use of ordinary
// function as StockRecord mutator.
type StockRecordFunc func(context.Context, *ent.StockRecordMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f StockRecordFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.StockRecordMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.StockRecordMutation", m)
}
